...
#obstacle positions for group 12
    ox, oy = [], []
    for i in range(-20, 70): # draw the bottom border
        #set a border with the x range from -20.0 to 70.0 at y = -10.0
        ox.append(i) 
        oy.append(-10.0)

    for i in range(-10, 60): # draw the right border
        #set a border with the y range from -10.0 to 60.0 at x = 70.0
        ox.append(70.0)
        oy.append(i)

    for i in range(-20, 70): # draw the top border
        #set a border with the x range from -20.0 to 70.0 at y = 60.0
        ox.append(i)
        oy.append(60.0)

    for i in range(-10, 60): # draw the left border
        #set a border with the y range from -10.0 to 60.0 at x = -20.0
        ox.append(-20.0)
        oy.append(i)

    # draw the free border
    ...
    for i in range(10, 30):
        ox.append(i)
        oy.append(-1 * i + 50) #in y=mx+c

    for i in range(40, 50):
        ox.append(i)
        oy.append(-2 * i + 130) #in y=mx+c
